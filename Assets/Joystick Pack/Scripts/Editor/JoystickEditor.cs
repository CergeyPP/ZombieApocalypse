...
public class JoystickEditor : Editor
{
    ...
    protected virtual void OnEnable()
    {
        ...
        controlPath = serializedObject.FindProperty("_controlPath");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(controlPath, new GUIContent("Control Path", "Select which control will be overwritten by joystick"));
